...
@section('body')
    ...
    <div id="main">
        <header>
            @if(Auth::user())
                ...
                <div class="crumbtrail">
                    ...
                    <i class="fa fa-angle-right"></i>
                    <a href="/projects/{{ $project->client->stub }}/{{ $project->stub }}/issues/create">Log an amendment</a>
                </div>
            @endif
            <h1>Log an amendment</h1>
        </header>
        @if(Session::has('tip'))
            <div class="tip">
                <i class="fa fa-info-circle"></i> The amendment was logged. You can <a href="/{{ Session::get('tip') }}">view it here</a>, <a href="/projects/{{ $project->client->stub }}/{{ $project->stub}}/issues">view all amendments</a> or log another below.
            </div>
        @else
            <div class="tip">
                <i class="fa fa-info-circle"></i> You are logging this to version <strong>{{ $project->current_version }}</strong> of {{ $project->name }}.
            </div>
        @endif
        ...
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            ...
            <br/><button type="submit"><i class="fa fa-arrow-circle-right"></i> Save</button>
