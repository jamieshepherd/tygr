...
@section('body')
    ...
    <div id="main">
        ...
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            ...
            <input name="name" type="text" placeholder="e.g. John Smith" autofocus>

            <label>Email address</label>
            <input name="email" type="text" placeholder="e.g. john.smith&#64;gmail.com">

            <label>Client</label>
            <input name="client" type="text" placeholder="e.g. 1">

            <label>Rank</label>
            <input name="rank" type="text" placeholder="e.g. 1">
